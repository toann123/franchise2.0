<?php
	$this->assign('title','FRANCHISE | BaseFees');
	$this->assign('nav','basefees');

	$this->display('_Header.tpl.php');
?>

<script type="text/javascript">
	$LAB.script("scripts/app/basefees.js").wait(function(){
...
<h1>
	<i class="icon-th-list"></i> BaseFees
	...
	<script type="text/template" id="baseFeeCollectionTemplate">
...
-->
	...
	<script type="text/template" id="baseFeeModelTemplate">
		...
		<form id="deleteBaseFeeButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					<label class="control-label"></label>
					<div class="controls">
						<button id="deleteBaseFeeButton" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Delete BaseFee</button>
						<span id="confirmDeleteBaseFeeContainer" class="hide">
							<button id="cancelDeleteBaseFeeButton" class="btn btn-mini">Cancel</button>
							<button id="confirmDeleteBaseFeeButton" class="btn btn-mini btn-danger">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<!-- modal edit dialog -->
	<div class="modal fade" id="baseFeeDetailDialog">
		<div class="modal-header">
			<a class="close" data-dismiss="modal">&times;</a>
			<h3>
				<i class="icon-edit"></i> Edit BaseFee
				<span id="modelLoader" class="loader progress progress-striped active"><span class="bar"></span></span>
			</h3>
		</div>
		<div class="modal-body">
			<div id="modelAlert"></div>
			<div id="baseFeeModelContainer"></div>
		</div>
		<div class="modal-footer">
			<button class="btn" data-dismiss="modal" >Cancel</button>
			<button id="saveBaseFeeButton" class="btn btn-primary">Save Changes</button>
		</div>
	</div>

	<div id="collectionAlert"></div>
	
	<div id="baseFeeCollectionContainer" class="collectionContainer">
	</div>

	<p id="newButtonContainer" class="buttonContainer">
		<button id="newBaseFeeButton" class="btn btn-primary">Add BaseFee</button>
	</p>
