<?php
	$this->assign('title','FRANCHISE | Posts');
	$this->assign('nav','posts');

	$this->display('_Header.tpl.php');
?>

<script type="text/javascript">
	$LAB.script("scripts/app/posts.js").wait(function(){
...
<h1>
	...
	<script type="text/template" id="postCollectionTemplate">
...
-->
	...
	<script type="text/template" id="postModelTemplate">
		...
		<form id="deletePostButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					<label class="control-label"></label>
					<div class="controls">
						<button id="deletePostButton" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Delete Post</button>
						<span id="confirmDeletePostContainer" class="hide">
							<button id="cancelDeletePostButton" class="btn btn-mini">Cancel</button>
							<button id="confirmDeletePostButton" class="btn btn-mini btn-danger">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<!-- modal edit dialog -->
	<div class="modal fade" id="postDetailDialog">
		...
		<div class="modal-body">
			...
			<div id="postModelContainer"></div>
		</div>
		<div class="modal-footer">
			<button class="btn" data-dismiss="modal" >Cancel</button>
			<button id="savePostButton" class="btn btn-primary">Save Changes</button>
		</div>
	</div>

	<div id="collectionAlert"></div>
	
	<div id="postCollectionContainer" class="collectionContainer">
	</div>

	<p id="newButtonContainer" class="buttonContainer">
		<button id="newPostButton" class="btn btn-primary">Add Post</button>
	</p>
