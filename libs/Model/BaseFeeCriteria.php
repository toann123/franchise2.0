...
require_once("DAO/BaseFeeCriteriaDAO.php");

/**
 * The BaseFeeCriteria class extends BaseFeeDAOCriteria and is used
 ...
 * @version 1.0
 */
class BaseFeeCriteria extends BaseFeeCriteriaDAO
{
