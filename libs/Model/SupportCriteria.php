...
require_once("DAO/SupportCriteriaDAO.php");

/**
 * The SupportCriteria class extends SupportDAOCriteria and is used
 ...
 * @version 1.0
 */
class SupportCriteria extends SupportCriteriaDAO
{
