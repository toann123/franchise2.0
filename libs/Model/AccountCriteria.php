...
require_once("DAO/AccountCriteriaDAO.php");

/**
 * The AccountCriteria class extends AccountDAOCriteria and is used
 ...
 * @version 1.0
 */
class AccountCriteria extends AccountCriteriaDAO
{
