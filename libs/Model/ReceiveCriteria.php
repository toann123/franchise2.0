...
require_once("DAO/ReceiveCriteriaDAO.php");

/**
 * The ReceiveCriteria class extends ReceiveDAOCriteria and is used
 ...
 * @version 1.0
 */
class ReceiveCriteria extends ReceiveCriteriaDAO
{
