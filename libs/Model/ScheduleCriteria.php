...
require_once("DAO/ScheduleCriteriaDAO.php");

/**
 * The ScheduleCriteria class extends ScheduleDAOCriteria and is used
 ...
 * @version 1.0
 */
class ScheduleCriteria extends ScheduleCriteriaDAO
{
