...
require_once("DAO/AccountTypeCriteriaDAO.php");

/**
 * The AccountTypeCriteria class extends AccountTypeDAOCriteria and is used
 ...
 * @version 1.0
 */
class AccountTypeCriteria extends AccountTypeCriteriaDAO
{
