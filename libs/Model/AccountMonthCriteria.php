...
require_once("DAO/AccountMonthCriteriaDAO.php");

/**
 * The AccountMonthCriteria class extends AccountMonthDAOCriteria and is used
 ...
 * @version 1.0
 */
class AccountMonthCriteria extends AccountMonthCriteriaDAO
{
