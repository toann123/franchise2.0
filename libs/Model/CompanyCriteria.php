...
require_once("DAO/CompanyCriteriaDAO.php");

/**
 * The CompanyCriteria class extends CompanyDAOCriteria and is used
 ...
 * @version 1.0
 */
class CompanyCriteria extends CompanyCriteriaDAO
{
