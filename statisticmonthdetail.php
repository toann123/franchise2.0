            ...
            <div class="span6">
                ...
                <div class="block-fluid">
                    <table cellpadding="0" cellspacing="0" width="50%" class="table">
                        <tbody>
                            <tr>
                                <td width="40%">Franchise fee</td>
                                <td width="60%">$177.04</td>
                            </tr>
                            <tr>
                                <td>Compliance discount</td>
                                <td>$177.04</td>
                            </tr>
                            <tr>
                                <td>Lead fee</td>
                            ...
                            <tr>
                                <td>National Branding Fee</td>
                                <td>$2.27</td>
                            </tr>
                            <tr>
                                <td>Booking Comfirmation Fee</td>
                                <td>$1.05</td>
                            </tr>
                            <tr>
                                <td><b>Total</b></td>
