            ...
            <div class="span6">
                ...
                <div class="block-fluid">
                    ...
                    <div class="row-form">
                        ...
                        <div class="span9">
                            <input type="text" class="form-control" value="Elise Chaudhry" style="border-color:red">
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="row-form">
            ...
            <div class="span6">
                ...
                <div class="block-fluid">
                    ...
                    <div class="row-form">
                        ...
                        <div class="span9">
                            <input type="text" class="form-control">
                            <input type="checkbox" value="checkbox1"/> Would customer like to receive the survey ?
                        </div>
                        <div class="clear"></div>
                    </div>
                </div>
            ...
            <div class="span12">
                ...
                <div class="block-fluid">
                    <div class="row-form">
                        ...
                        <div class="span4">
                            <select name="select" style="border-color:red">
                                <option value="0">choose a option...</option>
                                <option value="1">Andorra</option>
                                <option value="2">Antarctica</option>
                                <option value="3">Bulgaria</option>
                    ...
                    <div class="row-form">
                        ...
                        <div class="span4">
                            <input type="text" class="form-control" value="26/02/2015" readonly="true">
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="row-form">
                    ...
                    <div class="row-form">
                        <div class="span3"></div>
                        <div class="span9">
                            <a href="statistic.php"><button class="btn" type="button">Add Pickup</button></a>
