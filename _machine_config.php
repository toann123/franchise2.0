...
GlobalConfig::$CONNECTION_SETTING->DBName = "franchise";
...
/** the root url of the application with trailing slash, for example http://localhost/franchise/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'franchise2/';
