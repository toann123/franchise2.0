    ...
    <div class="workplace">
        <div class="row-fluid">
            <div class="span4">
                ...
                <div class="block-fluid">
                    <div class="row-form">
                        ...
                        <div class="span4">
                            <input type="text" class="form-control" value="513.90">
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="row-form">
                        ...
                        <div class="span4">
                            <input type="text" class="form-control" value="138.17">
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="row-form">
                        ...
                        <div class="span4">
                            <input type="text" class="form-control" value="78.98">
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="row-form">
                        ...
                        <div class="span4">
                            <input type="text" class="form-control" value="6.59">
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="row-form">
                    ...
                    <div class="row-form">
                        <div class="span8">
                            FSE Controlled mrk levy
                        </div>
                        <div class="span4">
                            <input type="text" class="form-control" value="24.57">
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="row-form">
                        ...
                        <div class="span4">
                            <input type="text" class="form-control" value="85%">
                        </div>
                        <div class="clear"></div>
                    </div>
                </div>
            ...
            <div class="span5">
                ...
                <div class="block-fluid">
                    <div class="row-form">
                        ...
                        <div class="span4">
                            <input type="text" class="form-control" value="14.47">
                        </div>
                        <div class="clear"></div>
                    </div>
                </div>
            ...
            <div class="span3">
                <div class="head">
                    <div class="isw-documents"></div>
                    <h1>Bill Statements</h1>
                    <div class="clear"></div>
                </div>
                <div class="block-fluid">
                    <div class="row-form">
                        <div class="span12">
                            <a href="statisticmonthdetail.php">
